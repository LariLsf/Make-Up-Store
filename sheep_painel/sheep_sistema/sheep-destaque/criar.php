    ...
    <div class="main-content">
     ...
     <!-- FIM TOKEN URL --->
        ...
        <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>sheep-destaque/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_um" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_dois" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_tres" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_quatro" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_cinco" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_seis" placeholder="Digite o título">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <select name="local" class="form-control">
                            <option value="BannerDestaque550x604">Banner Destaque - 550x604px</option>
                            <option value="BannerCTA550x604">Banner CTA - 550x604px</option>
