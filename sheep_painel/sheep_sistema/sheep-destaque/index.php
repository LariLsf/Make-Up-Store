<div class="main-content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= URL_CAMINHO_PAINEL . FILTROS ?>sheep-destaque/criar&token=<?= $_SESSION['timeWT'] ?> ">Novo</a></li>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                  ...
                  <tbody>
                    <?php
                      $sheep->Leitura('banners', "WHERE tipo = 'destaque' ORDER BY data DESC");
                    ...
                    ?>
                        <tr>
                          ...
                          <td><?= $banner->local ?></td>
                          <td><a href="<?= URL_CAMINHO_PAINEL . FILTROS . "sheep-destaque/atualizar&editar={$banner->id}&token={$_SESSION['timeWT']}" ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                          <td>
                            <form action="<?= URL_CAMINHO_PAINEL . FILTROS . 'sheep-destaque/filtros/excluir&token=' . $_SESSION['timeWT']?>" method="post">
