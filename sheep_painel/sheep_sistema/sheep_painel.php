  ...
  <section class="section">
    <div class="section-body">
      ...
      <div class="row ">
        ...
        <!-- INICIO PAGAMENTO APROVADO BLOCO -->
        ...
        <!-- FIM PAGAMENTO APROVADO BLOCO -->

        <!-- INICIO PAGAMENTO PENDENTE BLOCO -->
        <div class="col-xl-3 col-lg-6">
        ...
        <!-- FIM PAGAMENTO PENDENTE BLOCO -->

        <!-- INICIO PRODUTOS BLOCO -->
        <div class="col-xl-3 col-lg-6">
      ...
      <div class="row clearfix">
        ...
        <!--INICIO CONTADOR DE VISITAS EM CATEGORIA DE PRODUTOS -->
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-6">
          <div class="card">
            <div class="card-header">
        ...
        <!--FIM CONTADOR DE VISITAS EM CATEGORIA DE PRODUTOS -->
      ...
      <!-- INICIO CONTROLES EM GERAL DE ESTOQUE E PRODUTOS -->
      ...
      <div class="row">
        ...
        <!--INICIO CONTROLE DE ESTOQUE E PRODUTOS -->
        <div class="col-12 col-sm-6 col-lg-4">
                      ...
                      <div class="media-body">
                        ...
                        <div class="mt-1">
                          ...
                          <div class="budget-price ">
                            ...
                            <div class="budget-price-label" style="color:#fff; border-radius:5px; padding:10px">77</div>
                          </div>
        ...
        <!--FIM CONTROLE DEESTOQUE E PRODUTOS -->


        <!--INICIO FATURAS PRODUTOS -->
        <div class="col-12 col-sm-6 col-lg-4">
          <div class="card">
            <div class="card-header">
              <h4>Faturas</h4>
        ...
        <!--FIM FATURAS PRODUTOS -->


      </div>
      <!-- FIM CONTROLES EM GERAL DE ESTOQUE E PRODUTOS -->
